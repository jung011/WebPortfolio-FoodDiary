package com.example.Back_spring.controller.Board;
...
import com.example.Back_spring.service.BoardService;
...
public class BoardController {
    ...
    public ResponseEntity<? super PostCommentResponeDto> postComment (
            @RequestBody @Valid PostCommentRequestDto requestBody,
            @PathVariable("boardNumber") Long boardNumber,
            @AuthenticationPrincipal String email
    ) {
        ResponseEntity<? super PostCommentResponeDto> response = boardService.postComment(requestBody, boardNumber, email);
        return response;
    }

    @GetMapping("/{boardNumber}/comment-list")
    public ResponseEntity<? super   GetCommentListResponseDto> getCommetList (@PathVariable("boardNumber") Long boardNumber) {
    ...
    public ResponseEntity<? super GetTop3BoardListResponseDto> getTop3BoardList() {
        ResponseEntity<? super GetTop3BoardListResponseDto> response = boardService.getTpo3BoardList();
        return response;
    }
